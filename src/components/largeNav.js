  ...
  return (
    ...
    {/* the whole thing */}
      <div className="fixed w-full bg-blue-400">
        ...
        {/* middle part */}
        <div className='fixed top-0 left-1/2 transform -translate-x-1/2 h-40 w-40 flex flex-col items-center justify-center bg-yellow-700'>
          <img src={logoPic} className='h-24 w-24'/>
          <div>
            Cravan Construction
          </div>
